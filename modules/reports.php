...
<div class="container">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="get" action="/modules/reports.php" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-6 d-flex align-items-end">
                    ...
                    <a href="/modules/reports.php" class="btn btn-outline-secondary">
...
<form id="exportPdfForm" action="/modules/export_pdf.php" method="post" target="_blank" style="display: none;">
...
<form id="exportExcelForm" action="/modules/export_excel.php" method="post" target="_blank" style="display: none;">
    <input type="hidden" name="report_type" value="<?php echo $report_type; ?>">
    <input type="hidden" name="start_date" value="<?php echo $start_date; ?>">
    <input type="hidden" name="end_date" value="<?php echo $end_date; ?>">
    <input type="hidden" name="department_id" value="<?php echo $department_filter; ?>">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        <?php if (!empty($chart_data)): ?>
            ...
            <?php if ($report_type == 'leave_utilization'): ?>
                ...
                const leaveTypeData = {
                    labels: [<?php echo implode(', ', array_map(function($item) { return "'" . addslashes($item['name']) . "'"; }, $chart_data)); ?>],
                    datasets: [{
                        label: 'Days Taken',
                        data: [<?php echo implode(', ', array_map(function($item) { return $item['total_days']; }, $chart_data)); ?>],
                        backgroundColor: [<?php echo implode(', ', array_map(function($item) { return "'" . $item['color'] . "'"; }, $chart_data)); ?>],
                        borderWidth: 1
                    }]
                };
            ...
            <?php elseif ($report_type == 'department_summary'): ?>
                ...
                const deptData = {
                    labels: [<?php echo implode(', ', array_map(function($item) { return "'" . addslashes($item['department_name']) . "'"; }, $chart_data)); ?>],
                    datasets: [{
                        label: 'Approved Days',
                        data: [<?php echo implode(', ', array_map(function($item) { return $item['approved_days']; }, $chart_data)); ?>],
                        backgroundColor: 'rgba(40, 167, 69, 0.7)',
                        borderColor: 'rgba(40, 167, 69, 1)',
                        borderWidth: 1
                    }, {
                        label: 'Pending Days',
                        data: [<?php echo implode(', ', array_map(function($item) { return $item['pending_days']; }, $chart_data)); ?>],
                        backgroundColor: 'rgba(255, 193, 7, 0.7)',
                        borderColor: 'rgba(255, 193, 7, 1)',
                        borderWidth: 1
                    }, {
                        label: 'Rejected Days',
                        data: [<?php echo implode(', ', array_map(function($item) { return $item['rejected_days']; }, $chart_data)); ?>],
            ...
            <?php elseif ($report_type == 'monthly_trends'): ?>
                ...
                const trendsData = {
                    ...
                    datasets: [{
                        label: 'Applications',
                        data: [<?php echo implode(', ', array_map(function($item) { return $item['total_applications']; }, $chart_data)); ?>],
            ...
            <?php elseif ($report_type == 'leave_balance'): ?>
                ...
                const balanceData = {
                    ...
                    datasets: [{
                        label: 'Used Days',
                        data: [<?php echo implode(', ', array_map(function($item) { return $item['total_used']; }, $chart_data)); ?>],
                        backgroundColor: 'rgba(220, 53, 69, 0.7)',
                        borderColor: 'rgba(220, 53, 69, 1)',
                        borderWidth: 1
                    }, {
                        label: 'Remaining Days',
                        data: [<?php echo implode(', ', array_map(function($item) { return $item['total_remaining']; }, $chart_data)); ?>],
                        backgroundColor: 'rgba(40, 167, 69, 0.7)',
                        borderColor: 'rgba(40, 167, 69, 1)',
                        borderWidth: 1
                    }]
                ...
                // Chart.js not available - chart disabled
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            title: {
                                display: true,
                                text: 'Leave Balance by Department'
                            }
                        },
                        scales: {
                            x: {
